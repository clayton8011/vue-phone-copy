    ...
    <div class="shoplist_container">
        ...
        <ul v-else class="animation_opacity">
            <li class="list_back_li" v-for="item in 10" :key="item">
                <img src="../../images/icons/svg/shopback.svg" class="list_back_svg">
            </li>
        </ul>
        ...
        <div ref="abc" style="background: red;"></div>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            backTop(){
                adnimate(document.body,{scrollTop:'0'},400,'ease-out')
            },
            ...
            zhunshi(sup){
               let zhunstatus;
               if((sup instanceof Array) && sup.length){
                   sup.forEach(item =>{
                       if(item.icon_name === '准'){
                           zhunstatus=true;
                       }
