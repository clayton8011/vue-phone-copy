    ...
    export default {
        ...
        methods:{
            initData(){
                ...
                // alert(queryObj);
                this.image_path =queryObj.image_path;
                this.description=queryObj.description;
                this.month_sales=queryObj.month_sales;
                this.name=queryObj.name;
                this.rating=queryObj.rating;
                this.rating_count=queryObj.rating_count;
                this.satisfy_rate=queryObj.satisfy_rate;
                this.foods=queryObj.foods;
